...
namespace Payeer.Api.Json
{
    internal sealed class ActionJsonConverter : JsonConverter
    {
        ...
        {
            return objectType == typeof(IEnumerable<Entity>);
        }
        /// <summary>
        ...
        {
            if (!(value is IEnumerable<Entity>))
            {
                throw new ArgumentException("Value is no list", "value");
            }

            var entity = (IEnumerable<Entity>)value;
